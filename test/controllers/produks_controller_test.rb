...
class ProduksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produk" do
    assert_difference('Produk.count') do
      post produks_url, params: { produk: { content: @produk.content, title: @produk.title } }
    end
  ...
  test "should update produk" do
    patch produk_url(@produk), params: { produk: { content: @produk.content, title: @produk.title } }
